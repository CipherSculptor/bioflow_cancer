document.addEventListener('DOMContentLoaded', () => {
    ...
    if (existingData.name) {
        ...
        detailsForm.querySelector('input[placeholder="Enter your Blood Group"]').value = existingData.bloodGroup;
    ...
    detailsForm.addEventListener('submit', (e) => {
        ...
        const formData = {
            ...
            bloodGroup: detailsForm.querySelector('input[placeholder="Enter your Blood Group"]').value,
